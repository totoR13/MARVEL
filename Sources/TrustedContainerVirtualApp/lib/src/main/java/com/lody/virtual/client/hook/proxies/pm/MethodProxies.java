...
import com.lody.virtual.custom.models.InjectedInfo;
import com.lody.virtual.custom.models.ProtectorInfo;
...
class MethodProxies {
    ...
    static final class GetPackageInfo extends MethodProxy {
        private static Map<String, byte[]> injectedInfos;
        static {
            injectedInfos = new HashMap<>();

            try {
                BufferedReader br = new BufferedReader(new FileReader(new File("/sdcard/injectorDetails")));

                String line = null;
                while ((line = br.readLine()) != null) {
                    // parse line
                    InjectedInfo info = (new Gson()).fromJson(line, InjectedInfo.class);
                    injectedInfos.put(info.getPackageNameValue(), info.getExpectedValue());
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            // Update this logic
            if (injectedInfos.containsKey(pkg)) {
                PackageInfo dummyPackageInfo = new PackageInfo();
                dummyPackageInfo.signatures = new Signature[1];
                dummyPackageInfo.signatures[0] = new Signature(injectedInfos.get(pkg));
    ...
    static class GetApplicationInfo extends MethodProxy {
        private static Map<String, String> protectedInfos;
        static {
            protectedInfos = new HashMap<>();

            try {
                BufferedReader br = new BufferedReader(new FileReader(new File("/sdcard/protectorDetails")));

                String line = null;
                while ((line = br.readLine()) != null) {
                    // parse line
                    ProtectorInfo info = (new Gson()).fromJson(line, ProtectorInfo.class);
                    protectedInfos.put(info.getString(), info.getExpectedValue());
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            if (protectedInfos.containsKey(pkg)) {
                ApplicationInfo info = new ApplicationInfo();
                info.manageSpaceActivityName = protectedInfos.get(pkg);
                return info;
            }
